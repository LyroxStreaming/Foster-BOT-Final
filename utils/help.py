    ...
    async def callback(self, interaction: discord.Interaction):
        if self.invoker == interaction.user:
            ...
            await interaction.response.send_message(
                "<:lh_no:1189499009707032576> Hey it's not your session !", ephemeral=True)
        ...
        for cog in self.get_cogs():
            if "help_custom" in dir(cog):
                ...
                embed = discord.Embed(title=f"{emoji} {label} Commands",
                                      color=0x01f5b6)
                embed.set_footer(
                    text="Made with 💖 by ~ mtx.lyrox",
                    icon_url=
                    "https://cdn.discordapp.com/avatars/996060367585300490/a_0a8439f94c497c2ffed765e42c1a2d9b.gif?size=1024"
                )
