...
class antipinginv(Cog):
    ...
    async def on_message(self, message):
      button = Button(emoji="<:jk_inv:1051073323284561940>",label="Invite", url =  "https://discord.com/oauth2/authorize?client_id=1189212094592196691&permissions=2113268958&scope=bot")
      button1 = Button(emoji="<:jk_support:1051073711463211068>",label="Support", url = "https://discord.gg/HPwNkKsSUJ")
        ...
        with open('ignore.json', 'r') as heck:
          ...
          if message.mention_everyone:
            ...
            if str(message.author.id) in data2["ids"]:
              embed = discord.Embed(title="<a:lh_skull:1189498111933034557> Blacklisted", description="You Are Blacklisted From Using My Commands.\nIf You Think That It Is A Mistake, You Can Appeal In Our Support Server By Clicking [here](https://discord.gg/HPwNkKsSUJ)")
