                ...
                if antiSpam is True:
                 ...
                 #   if not punish_cd_bucket.update_rate_limit():
                      if data["punishment"] == "kick":
                        ...
                        hacker = discord.Embed(color=0x2f3136,description=f"<a:lh_arrow:1189498009067720775> | Successfully Muted {message.author} For Spamming")
                      ...
                      if data["punishment"] == "ban":
                        now = discord.utils.utcnow()
                        await message.author.timeout(now + datetime.timedelta(minutes=15), reason="Astroz | Anti Spam")
                        hacker1 = discord.Embed(color=0x2f3136,description=f"<a:lh_arrow:1189498009067720775> | Successfully Muted {message.author} For Spamming")
                      ...
                      if data["punishment"] == "none":
                        now = discord.utils.utcnow()
                        await message.author.timeout(now + datetime.timedelta(minutes=15), reason="Astroz | Anti Spam")
                        hacker2 = discord.Embed(color=0x2f3136,description=f"<a:lh_arrow:1189498009067720775> | Successfully Muted {message.author} For Spamming")
                ...
                if antiLink is True:
                    ...
                    if invite_matches:
                        ...
                        if data["punishment"] == "kick":
                            ...
                            hacker3 = discord.Embed(color=0x2f3136,description=f"<a:lh_arrow:1189498009067720775> | Successfully Muted {message.author} For Sending Discord Server Invites")
                        ...
                        if data["punishment"] == "ban":
                            await message.author.timeout(now + datetime.timedelta(minutes=15), reason="Astroz | Anti Discord Invites")
                            hacker4 = discord.Embed(color=0x2f3136,description=f"<a:lh_arrow:1189498009067720775> | Successfully Muted {message.author} For Sending Discord Server Invites")
                        ...
                        if data["punishment"] == "none":
                             now = discord.utils.utcnow()
                             await message.author.timeout(now + datetime.timedelta(minutes=15), reason="Astroz | Anti Discord Invites")
                             hacker5 = discord.Embed(color=0x2f3136,description=f"<a:lh_arrow:1189498009067720775> | Successfully Muted {message.author} For Sending Discord Server Invites")
                    ...
                    if link_matches:
                        if data["punishment"] == "kick":
                          ...
                          hacker6 = discord.Embed(color=0x2f3136,description=f"<a:lh_arrow:1189498009067720775> | Successfully Muted {message.author} For Sending Links")
                        ...
                        if data["punishment"] == "ban":
                          await message.author.timeout(now + datetime.timedelta(minutes=15), reason="Astroz | Anti Link")
                          hacker7 = discord.Embed(color=0x2f3136,description=f"<a:lh_arrow:1189498009067720775> | Successfully Muted {message.author} For Sending Links")
                        ...
                        if data["punishment"] == "none":
                          now = discord.utils.utcnow()
                          await message.author.timeout(now + datetime.timedelta(minutes=15), reason="Astroz | Anti Link")
                          hacker8 = discord.Embed(color=0x2f3136,description=f"<a:lh_arrow:1189498009067720775> | Successfully Muted {message.author} For Sending Links")
