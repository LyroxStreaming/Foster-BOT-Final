...
class Server(commands.Cog):
    ...
    async def add_role(self, *, role: int, member: discord.Member):
        if member.guild.me.guild_permissions.manage_roles:
            ...
            await member.add_roles(role, reason="FosterLK | Role Added ")

    async def remove_role(self, *, role: int, member: discord.Member):
        if member.guild.me.guild_permissions.manage_roles:
            role = discord.Object(id=int(role))
            await member.remove_roles(role, reason="FosterLK | Role Removed")
    ...
    async def _owner(self, context: Context, member: discord.Member) -> None:
        if data := getConfig(context.guild.id):
            ...
            hacker = discord.Embed(
                description=
                f"<:lh_yes:1189499011900653608> | Successfully Given <@&{role}> To {member.mention}",
                color=0x2f3136)
            ...
            hacker1 = discord.Embed(
                description=
                f"<a:lh_magic:1189498059172880444> | Owner role is not setuped in {context.guild.name}",
                color=0x2f3136)
    ...
    async def _coowner(self, context: Context, member: discord.Member) -> None:
        if data := getConfig(context.guild.id):
            ...
            hacker1 = discord.Embed(
                description=
                f"<a:lh_magic:1189498059172880444> | Co Owner role is not setuped in {context.guild.name}",
                color=0x2f3136)
            hacker1.set_author(name=f"{context.author}",
                               icon_url=f"{context.author.avatar}")
            hacker1.set_thumbnail(url=f"{context.author.avatar}")
    ...
    async def _headadmin(self, context: Context,
        ...
        if data := getConfig(context.guild.id):
            ...
            hacker1 = discord.Embed(
                description=
                f"<a:lh_magic:1189498059172880444> | Head Admin role is not setuped in {context.guild.name}",
                color=0x2f3136)
            hacker1.set_author(name=f"{context.author}",
                               icon_url=f"{context.author.avatar}")
            hacker1.set_thumbnail(url=f"{context.author.avatar}")
    ...
    async def _admin(self, context: Context, member: discord.Member) -> None:
        if data := getConfig(context.guild.id):
            ...
            hacker1 = discord.Embed(
                description=
                f"<a:lh_magic:1189498059172880444> | Admin role is not setuped in {context.guild.name}",
                color=0x2f3136)
            hacker1.set_author(name=f"{context.author}",
                               icon_url=f"{context.author.avatar}")
            hacker1.set_thumbnail(url=f"{context.author.avatar}")
    ...
    async def _girladmin(self, context: Context,
        ...
        if data := getConfig(context.guild.id):
            ...
            hacker1 = discord.Embed(
                description=
                f"<a:lh_magic:1189498059172880444> | Girl Admin role is not setuped in {context.guild.name}",
                color=0x2f3136)
            hacker1.set_author(name=f"{context.author}",
                               icon_url=f"{context.author.avatar}")
            hacker1.set_thumbnail(url=f"{context.author.avatar}")
    ...
    async def _headmod(self, context: Context, member: discord.Member) -> None:
        if data := getConfig(context.guild.id):
            ...
            hacker1 = discord.Embed(
                description=
                f"<a:lh_magic:1189498059172880444> | Head Mod role is not setuped in {context.guild.name}",
                color=0x2f3136)
            hacker1.set_author(name=f"{context.author}",
                               icon_url=f"{context.author.avatar}")
            hacker1.set_thumbnail(url=f"{context.author.avatar}")
    ...
    async def _mod(self, context: Context, member: discord.Member) -> None:
        if data := getConfig(context.guild.id):
            ...
            hacker1 = discord.Embed(
                description=
                f"<a:lh_magic:1189498059172880444> | Mod role is not setuped in {context.guild.name}",
                color=0x2f3136)
            hacker1.set_author(name=f"{context.author}",
                               icon_url=f"{context.author.avatar}")
            hacker1.set_thumbnail(url=f"{context.author.avatar}")
    ...
    async def _girlmod(self, context: Context, member: discord.Member) -> None:
        if data := getConfig(context.guild.id):
            ...
            hacker1 = discord.Embed(
                description=
                f"<a:lh_magic:1189498059172880444> | Girl Mod role is not setuped in {context.guild.name}",
                color=0x2f3136)
            hacker1.set_author(name=f"{context.author}",
                               icon_url=f"{context.author.avatar}")
            hacker1.set_thumbnail(url=f"{context.author.avatar}")
    ...
    async def staff(self, context: Context, role: discord.Role) -> None:
        if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
            if data := getConfig(context.guild.id):
                ...
                hacker = discord.Embed(
                    description=
                    f"<:lh_yes:1189499011900653608> | Successfully Setuped `Staff` Role To {role.mention}",
                    color=0x2f3136)
                hacker.set_author(name=f"{context.author}",
                                  icon_url=f"{context.author.avatar}")
                hacker.set_thumbnail(url=f"{context.author.avatar}")
    ...
    async def girl(self, context: Context, role: discord.Role) -> None:
        if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
            if data := getConfig(context.guild.id):
                ...
                hacker = discord.Embed(
                    description=
                    f"<:lh_yes:1189499011900653608> | Successfully Setuped `girl` Role To {role.mention}",
                    color=0x2f3136)
                hacker.set_author(name=f"{context.author}",
                                  icon_url=f"{context.author.avatar}")
                hacker.set_thumbnail(url=f"{context.author.avatar}")
    ...
    async def vip(self, context: Context, role: discord.Role) -> None:
        if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
            if data := getConfig(context.guild.id):
                ...
                hacker = discord.Embed(
                    description=
                    f"<:lh_yes:1189499011900653608> | Successfully Setuped `vip` Role To {role.mention}",
                    color=0x2f3136)
                hacker.set_author(name=f"{context.author}",
                                  icon_url=f"{context.author.avatar}")
                hacker.set_thumbnail(url=f"{context.author.avatar}")
    ...
    async def guest(self, context: Context, role: discord.Role) -> None:
        if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
            if data := getConfig(context.guild.id):
                ...
                hacker = discord.Embed(
                    description=
                    f"<:lh_yes:1189499011900653608> | Successfully Setuped `guest` Role To {role.mention}",
                    color=0x2f3136)
                hacker.set_author(name=f"{context.author}",
                                  icon_url=f"{context.author.avatar}")
                hacker.set_thumbnail(url=f"{context.author.avatar}")
    ...
    async def friend(self, context: Context, role: discord.Role) -> None:
        if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
            if data := getConfig(context.guild.id):
                ...
                hacker = discord.Embed(
                    description=
                    f"<:lh_yes:1189499011900653608> | Successfully Setuped `friend` Role To {role.mention}",
                    color=0x2f3136)
                hacker.set_author(name=f"{context.author}",
                                  icon_url=f"{context.author.avatar}")
                hacker.set_thumbnail(url=f"{context.author.avatar}")
    ...
    async def owner(self, context: Context, role: discord.Role) -> None:
        if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
            if data := getConfig(context.guild.id):
                ...
                hacker = discord.Embed(
                    description=
                    f"<:lh_yes:1189499011900653608> | Successfully Setuped `Owner` Role To {role.mention}",
                    color=0x2f3136)
                hacker.set_author(name=f"{context.author}",
                                  icon_url=f"{context.author.avatar}")
                hacker.set_thumbnail(url=f"{context.author.avatar}")
    ...
    async def coowner(self, context: Context, role: discord.Role) -> None:
        if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
            if data := getConfig(context.guild.id):
                ...
                hacker = discord.Embed(
                    description=
                    f"<:lh_yes:1189499011900653608> | Successfully Setuped `Co Owner` Role To {role.mention}",
                    color=0x2f3136)
                hacker.set_author(name=f"{context.author}",
                                  icon_url=f"{context.author.avatar}")
                hacker.set_thumbnail(url=f"{context.author.avatar}")
    ...
    async def headadmin(self, context: Context, role: discord.Role) -> None:
        if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
            if data := getConfig(context.guild.id):
                ...
                hacker = discord.Embed(
                    description=
                    f"<:lh_yes:1189499011900653608> | Successfully Setuped `Head Admin` Role To {role.mention}",
                    color=0x2f3136)
                hacker.set_author(name=f"{context.author}",
                                  icon_url=f"{context.author.avatar}")
                hacker.set_thumbnail(url=f"{context.author.avatar}")
    ...
    async def admin(self, context: Context, role: discord.Role) -> None:
        if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
            if data := getConfig(context.guild.id):
                ...
                hacker = discord.Embed(
                    description=
                    f"<:lh_yes:1189499011900653608> | Successfully Setuped `Admin` Role To {role.mention}",
                    color=0x2f3136)
                hacker.set_author(name=f"{context.author}",
                                  icon_url=f"{context.author.avatar}")
                hacker.set_thumbnail(url=f"{context.author.avatar}")
    ...
    async def headmod(self, context: Context, role: discord.Role) -> None:
        if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
            if data := getConfig(context.guild.id):
                ...
                hacker = discord.Embed(
                    description=
                    f"<:lh_yes:1189499011900653608> | Successfully Setuped `Head Mod` Role To {role.mention}",
                    color=0x2f3136)
                hacker.set_author(name=f"{context.author}",
                                  icon_url=f"{context.author.avatar}")
                hacker.set_thumbnail(url=f"{context.author.avatar}")
    ...
    async def mod(self, context: Context, role: discord.Role) -> None:
        if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
            if data := getConfig(context.guild.id):
                ...
                hacker = discord.Embed(
                    description=
                    f"<:lh_yes:1189499011900653608> | Successfully Setuped `Mod` Role To {role.mention}",
                    color=0x2f3136)
                hacker.set_author(name=f"{context.author}",
                                  icon_url=f"{context.author.avatar}")
                hacker.set_thumbnail(url=f"{context.author.avatar}")
    ...
    async def girladmin(self, context: Context, role: discord.Role) -> None:
        if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
            if data := getConfig(context.guild.id):
                ...
                hacker = discord.Embed(
                    description=
                    f"<:lh_yes:1189499011900653608> | Successfully Setuped `Girl Admin` Role To {role.mention}",
                    color=0x2f3136)
                hacker.set_author(name=f"{context.author}",
                                  icon_url=f"{context.author.avatar}")
                hacker.set_thumbnail(url=f"{context.author.avatar}")
    ...
    async def girlmod(self, context: Context, role: discord.Role) -> None:
        if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
            if data := getConfig(context.guild.id):
                ...
                hacker = discord.Embed(
                    description=
                    f"<:lh_yes:1189499011900653608> | Successfully Setuped `Girl Mod` Role To {role.mention}",
                    color=0x2f3136)
                hacker.set_author(name=f"{context.author}",
                                  icon_url=f"{context.author.avatar}")
                hacker.set_thumbnail(url=f"{context.author.avatar}")
    ...
    async def rsta(self, context: Context) -> None:
        if data := getConfig(context.guild.id):
            ...
            embed = discord.Embed(
                ...
                color=0x2f3136)
            embed.add_field(
                name="<a:lh_arrow:1189498009067720775> Staff Role:",
                value=f"{staffr}",
                inline=False)
            embed.add_field(
                name="<a:lh_arrow:1189498009067720775> Girl Role:",
                value=f"{girlr}",
                inline=False)
            embed.add_field(name="<a:lh_arrow:1189498009067720775> Vip Role:",
                            value=f"{vipr}",
                            inline=False)
            embed.add_field(
                name="<a:lh_arrow:1189498009067720775> Guest Role:",
                value=f"{guestr}",
                inline=False)
            embed.add_field(
                name="<a:lh_arrow:1189498009067720775> Friend Role:",
                value=f"{frndr}",
                inline=False)
            embed.add_field(
                name="<a:lh_arrow:1189498009067720775> Owner Role:",
                value=f"{own}",
                inline=False)
            embed.add_field(
                name="<a:lh_arrow:1189498009067720775> Co Owner Role:",
                value=f"{coown}",
                inline=False)
            embed.add_field(
                name="<a:lh_arrow:1189498009067720775> Head Admin Role:",
                value=f"{headmin}",
                inline=False)
            embed.add_field(
                name="<a:lh_arrow:1189498009067720775> Admin Role:",
                value=f"{adminss}",
                inline=False)
            embed.add_field(
                name="<a:lh_arrow:1189498009067720775> Girl Admin Role:",
                value=f"{gadminss}",
                inline=False)
            embed.add_field(
                name="<a:lh_arrow:1189498009067720775> Head Mod Role:",
                value=f"{hmod}",
                inline=False)
            embed.add_field(name="<a:lh_arrow:1189498009067720775> Mod Role:",
                            value=f"{mod}",
                            inline=False)
            embed.add_field(
                name="<a:lh_arrow:1189498009067720775> Girl Mod Role:",
                value=f"{gmod}",
                inline=False)
    ...
    async def rstaff(self, context: Context, member: discord.Member) -> None:
        if data := getConfig(context.guild.id):
            ...
            hacker = discord.Embed(
                description=
                f"<:lh_yes:1189499011900653608> | Successfully Removed <@&{role}> From {member.mention}",
                color=0x2f3136)
            hacker.set_author(name=f"{context.author}",
                              icon_url=f"{context.author.avatar}")
            hacker.set_thumbnail(url=f"{context.author.avatar}")
    ...
    async def _create(self, ctx, name, *, message):
        ...
        if str(ctx.guild.id) in autoresponse:
            ...
            if len(numbers) >= 20:
                hacker6 = discord.Embed(
                    title="FosterLK",
                    description=
                    f"<a:sirenred:1182717716747010129> You can\'t add more than 20 autoresponses in {ctx.guild.name}",
                    color=0x2f3136)
        ...
        if str(ctx.guild.id) in autoresponse:
            if name in autoresponse[str(ctx.guild.id)]:
                hacker = discord.Embed(
                    title="FosterLK",
                    description=
                    f"<a:sirenred:1182717716747010129> The autoresponse with the `{name}` is already in {ctx.guild.name}",
                    color=0x2f3136)
        ...
        if str(ctx.guild.id) in autoresponse:
            ...
            hacker1 = discord.Embed(
                title="FosterLK",
                description=
                f"<a:lh_checkout:1189498036913700956> | Successfully Created Autoresponder in {ctx.guild.name} with the `{name}`",
                color=0x2f3136)
        ...
        if str(ctx.guild.id) in autoresponse:
            if name in autoresponse[str(ctx.guild.id)]:
                ...
                hacker1 = discord.Embed(
                    title="FosterLK",
                    description=
                    f"<a:lh_checkout:1189498036913700956> | Successfully Deleted Autoresponder in {ctx.guild.name} with the `{name}`",
                    color=0x2f3136)
                hacker1.set_author(name=f"{ctx.author}",
                                   icon_url=f"{ctx.author.avatar}")
                hacker1.set_thumbnail(url=f"{ctx.author.avatar}")
                ...
                hacker = discord.Embed(
                    title="FosterLK",
                    description=
                    f"<a:sirenred:1182717716747010129> No Autoresponder Found With The Name `{name}` In {ctx.guild.name}",
                    color=0x2f3136)
                hacker.set_author(name=f"{ctx.author}",
                                  icon_url=f"{ctx.author.avatar}")
                hacker.set_thumbnail(url=f"{ctx.author.avatar}")
            ...
            hacker2 = discord.Embed(
                title="FosterLK",
                description=
                f"<a:sirenred:1182717716747010129> There is no Autoresponder in {ctx.guild.name}",
                color=0x2f3136)
            hacker2.set_author(name=f"{ctx.author}",
                               icon_url=f"{ctx.author.avatar}")
            hacker2.set_thumbnail(url=f"{ctx.author.avatar}")
        ...
        if str(ctx.guild.id) in autoresponse:
            if name in autoresponse[str(ctx.guild.id)]:
                ...
                hacker1 = discord.Embed(
                    title="FosterLK",
                    description=
                    f"<a:lh_checkout:1189498036913700956> | Successfully Edited Autoresponder in {ctx.guild.name} with the `{name}`",
                    color=0x2f3136)
                hacker1.set_author(name=f"{ctx.author}",
                                   icon_url=f"{ctx.author.avatar}")
                hacker1.set_thumbnail(url=f"{ctx.author.avatar}")
