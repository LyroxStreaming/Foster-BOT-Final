...
class Moderation(commands.Cog):
    ...
    async def unlockall(self,
        ...
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            "<a:lh_arrow:1189498009067720775> | Unlocking all channels in few seconds .",
    ...
    async def lockall(self, ctx, server: discord.Guild = None, *, reason=None):
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            "<a:lh_arrow:1189498009067720775> | Locking all channels in few seconds .",
            timestamp=ctx.message.created_at)
        hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
        await ctx.reply(embed=hacker)
    ...
    async def hackban(self, ctx, userid, *, reason=None):
        ...
        try:
            ...
            await ctx.reply(embed=discord.Embed(
                description=
                f"<a:lh_arrow:1189498009067720775> | Successfully hackbanned {userid} for {reason}",
                color=0x2f3136))
        except:
            await ctx.reply(embed=discord.Embed(
    ...
    async def give(
        ...
        if guild.me.top_role >= ctx.author.top_role:
            embed = discord.Embed(
                color=0x2f3136,
                description=
                "<:lh_no:1189499009707032576> | Your role is below the bot.")
            await ctx.send(embed=embed)
            return
        if member.top_role >= ctx.author.top_role:
            await ctx.send(
                "**<:lh_no:1189499009707032576> | The provided user has roles that are above or have the same role as you.**"
            )
            return
        else:
    ...
    async def _hideall(self, ctx):
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            "<a:lh_arrow:1189498009067720775> | Hiding all channels in few seconds .",
            timestamp=ctx.message.created_at)
        hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
    ...
    async def _unhideall(self, ctx):
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            f"<a:lh_arrow:1189498009067720775> | Unhiding all channels in few seconds .",
            timestamp=ctx.message.created_at)
        hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
        #hacker.set_thumbnail(url =f"{ctx.author.avatar}")
    ...
    async def _hide(self, ctx, channel: discord.TextChannel = None):
        ...
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            f"<a:lh_arrow:1189498009067720775> | Succefully Hidden {channel.mention} .",
            timestamp=ctx.message.created_at)
        hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
        hacker.set_thumbnail(url=f"{ctx.author.avatar}")
    ...
    async def _unhide(self, ctx, channel: discord.TextChannel = None):
        ...
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            f"<a:lh_arrow:1189498009067720775> | Succefully Unhidden {channel.mention} .",
            timestamp=ctx.message.created_at)
        hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
        hacker.set_thumbnail(url=f"{ctx.author.avatar}")
...
Reason: `{entry.reason}`\n\n''')
    ...
    async def _prefix(self, ctx: commands.Context, prefix):
      ...
      if ctx.author.id in mod:         
          ...
          await ctx.reply(embed=discord.Embed(
            description=
            f"<:lh_yes:1189499011900653608> | Successfully Changed Prefix For **{ctx.guild.name}**\nNew Prefix for **{ctx.guild.name}** is : `{prefix}`\nUse `{prefix}help` For More info .",
            color=0x2f3136))
      else:
    ...
    async def _softban(self,
        ...
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            f"<a:lh_arrow:1189498009067720775> | Sucessfully soft-banned {member}.",
            timestamp=ctx.message.created_at)
        hacker.set_footer(text=f"Made With 💖 By ~ mtx.lyrox",icon_url= "https://cdn.discordapp.com/avatars/996060367585300490/a_0a8439f94c497c2ffed765e42c1a2d9b.gif?size=1024")
        hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
        hacker.set_thumbnail(url=f"{ctx.author.avatar}")
    ...
    async def purge(self, ctx, amount: int = 10):
        ...
        return await ctx.send(
            f"**<a:lh_arrow:1189498009067720775> Deleted {len(deleted)-1} message(s)**"
        )
    ...
    async def startswith(self, ctx, key, amount: int = 10):
        ...
        return await ctx.send(
            f"**<a:lh_arrow:1189498009067720775> Deleted {len(deleted)}/{amount} message(s) which started with the given keyword**"
        )
    ...
    async def endswith(self, ctx, key, amount: int = 10):
        ...
        deleted = await ctx.channel.purge(limit=100, check=check)
        return await ctx.send(
            f"**<a:lh_arrow:1189498009067720775> Deleted {len(deleted)}/{amount} message(s) which ended with the given keyword**"
        )
    ...
    async def contains(self, ctx, key, amount: int = 10):
        ...
        deleted = await ctx.channel.purge(limit=100, check=check)
        return await ctx.send(
            f"**<a:lh_arrow:1189498009067720775> Deleted {len(deleted)}/{amount} message(s) which contained the given keyword**"
        )
    ...
    async def user(self, ctx, user: discord.Member, amount: int = 10):
        ...
        deleted = await ctx.channel.purge(limit=100, check=check)
        return await ctx.send(
            f"**<a:lh_arrow:1189498009067720775> Deleted {len(deleted)}/{amount} message(s) which were sent by the mentioned user**"
        )
    ...
    async def invites(self, ctx, amount: int = 10):
        ...
        deleted = await ctx.channel.purge(limit=100, check=check)
        return await ctx.send(
            f"**<a:lh_arrow:1189498009067720775> Deleted {len(deleted)}/{amount} message(s) which contained invites**"
        )
    ...
    async def _mute(self, ctx, member: discord.Member, duration):
        ...
        if tame == -1:
            hacker3 = discord.Embed(
                color=0x2f3136,
                description=
                f"<:lh_no:1189499009707032576> | You didnt didnt gave time with correct unit\nExamples:\n{ctx.prefix}mute{ctx.author} 10m\n{ctx.prefix}mute {ctx.author} 5hr",
                timestamp=ctx.message.created_at)
            ...
            hacker4 = discord.Embed(
                color=0x2f3136,
                description=
                f"<:lh_no:1189499009707032576> | Time must be an integer!",
                timestamp=ctx.message.created_at)
            ...
            if till.lower() == "d":
                ...
                hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    "<a:lh_arrow:1189498009067720775> | Successfully Muted {0.mention} For {1} Day(s)"
                    .format(member, ok),
                    timestamp=ctx.message.created_at)
            elif till.lower() == "m":
                t = datetime.timedelta(seconds=tame)
                hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    "<a:lh_arrow:1189498009067720775> | Successfully Muted {0.mention} For {1} Minute(s)"
                    .format(member, ok),
                    timestamp=ctx.message.created_at)
            elif till.lower() == "s":
                t = datetime.timedelta(seconds=tame)
                hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    "<a:lh_arrow:1189498009067720775> | Successfully Muted {0.mention} For {1} Second(s)"
                    .format(member, ok),
                    timestamp=ctx.message.created_at)
            elif till.lower() == "h":
                t = datetime.timedelta(seconds=tame)
                hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    "<a:lh_arrow:1189498009067720775> | Successfully Muted {0.mention} For {1} Hour(s)"
                    .format(member, ok),
                    timestamp=ctx.message.created_at)
        try:
            if member.guild_permissions.administrator:
                hacker1 = discord.Embed(
                    color=0x2f3136,
                    description=
                    "<:lh_no:1189499009707032576> | I can\'t mute administrators",
                    timestamp=ctx.message.created_at)
        ...
        if member.is_timed_out():
            try:
                ...
                hacker5 = discord.Embed(
                    color=0x2f3136,
                    description=
                    f"<a:lh_arrow:1189498009067720775> | Successfully Unmuted {member.name}",
                    timestamp=ctx.message.created_at)
                ...
                hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    "<:lh_no:1189499009707032576> | Unable to Remove Timeout:\n```py\n{}```"
                    .format(e),
                    timestamp=ctx.message.created_at)
                await ctx.send(embed=hacker)
        else:
            hacker1 = discord.Embed(
                color=0x2f3136,
                description="<:lh_no:1189499009707032576> | {} Is Not Muted".
    ...
    async def _kick(self,
        ...
        if ctx.author.top_role.position > member.top_role.position or member == ctx.guild.owner:
            ...
            hacker = discord.Embed(
                color=0x2f3136,
                description=
                f"<a:lh_arrow:1189498009067720775> | {member.display_name} has been kicked from this guild, for: {reason}",
                timestamp=ctx.message.created_at)
            hacker.set_footer(text=f"Made With 💖 By ~ mtx.lyrox",icon_url= "https://cdn.discordapp.com/avatars/996060367585300490/a_0a8439f94c497c2ffed765e42c1a2d9b.gif")
            hacker.set_author(name=f"{ctx.author.name}",
                              icon_url=f"{ctx.author.avatar}")
            hacker.set_thumbnail(url=f"{ctx.author.avatar}")
            await ctx.send(embed=hacker)
            hacker1 = discord.Embed(
                ...
                timestamp=ctx.message.created_at)
            hacker1.set_footer(text=f"Made With 💖 By ~ mtx.lyrox",icon_url= "https://cdn.discordapp.com/avatars/996060367585300490/a_0a8439f94c497c2ffed765e42c1a2d9b.gif")
            hacker1.set_thumbnail(url = "https://cdn.discordapp.com/avatars/996060367585300490/a_0a8439f94c497c2ffed765e42c1a2d9b.gif?size=1024")
        ...
        if not ctx.author.top_role.position > member.top_role.position and ctx.author != ctx.guild.owner:
            await ctx.send(
                "*<:lh_no:1189499009707032576> | You cannot kick someone with a higher role than you!*"
            )
    ...
    async def _warn(self,
        ...
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            f"<a:lh_arrow:1189498009067720775> | {member.display_name} has been warned for: {reason}",
            timestamp=ctx.message.created_at)
        hacker.set_footer(text=f"Made With 💖 By ~ mtx.lyrox",icon_url= "https://cdn.discordapp.com/avatars/996060367585300490/a_0a8439f94c497c2ffed765e42c1a2d9b.gif")
        hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
    ...
    async def _ban(self,
        ...
        if ctx.author.top_role.position > member.top_role.position or ctx.author == ctx.guild.owner:
            ...
            hacker = discord.Embed(
                color=0x00FFE4,
                description=
                f"<a:lh_arrow:1189498009067720775> | {member.display_name} has been successfully banned for the reason: `{reason}`",
                timestamp=ctx.message.created_at)
            hacker.set_author(name=f"{ctx.author.name}",
                              icon_url=f"{ctx.author.avatar}")
            hacker.set_thumbnail(url=f"{ctx.author.avatar}")
        ...
        if not ctx.author.top_role.position > member.top_role.position and ctx.author != ctx.guild.owner:
            embed = discord.Embed(
                color=0x00FFE4,
                description=
                f"*<:lh_no:1189499009707032576> | You cannot ban someone with a higher role than you.*",
                timestamp=ctx.message.created_at)
            await ctx.send(embed=embed)
    ...
    async def _unban(self, ctx: commands.Context, id: int):
        ...
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            f"<a:lh_arrow:1189498009067720775> | {user.name} has been successfully unbanned",
            timestamp=ctx.message.created_at)
        hacker.set_footer(text=f"Made With 💖 By ~ mtx.lyrox",icon_url= "https://cdn.discordapp.com/avatars/996060367585300490/a_0a8439f94c497c2ffed765e42c1a2d9b.gif")
        hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
    ...
    async def clone(self, ctx: commands.Context, channel: discord.TextChannel):
        ...
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            f"<a:lh_arrow:1189498009067720775> | {channel.name} has been successfully cloned",
            timestamp=ctx.message.created_at)
        hacker.set_footer(text=f"Made With 💖 By ~ mtx.lyrox",icon_url= "https://cdn.discordapp.com/avatars/996060367585300490/a_0a8439f94c497c2ffed765e42c1a2d9b.gif")
        hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
    ...
    async def changenickname(self, ctx: commands.Context,
        ...
        hacker = discord.Embed(
            color=0x2f3136,
            description=
            f"<a:lh_arrow:1189498009067720775> | Successfully changed nickname of {member.name}",
            timestamp=ctx.message.created_at)
        hacker.set_author(name=f"{ctx.author.name}",
                          icon_url=f"{ctx.author.avatar}")
        hacker.set_thumbnail(url=f"{ctx.author.avatar}")
    ...
    async def _reactions(self, ctx, search=1000):
        ...
        await ctx.send(embed=discord.Embed(
            description=
            f"<a:lh_arrow:1189498009067720775> | Successfully Removed {total_reactions}.",
            color=0x2f3136))
    ...
    async def _nuke(self,
        ...
        button = Button(label="Yes",
                        ...
                        emoji="<:lh_yes:1189499011900653608>")
        button1 = Button(label="No",
                         style=discord.ButtonStyle.red,
                         emoji="<a:sirenred:1182717716747010129>")
    ...
    async def _lock(self,
        ...
        try:
            await channel.set_permissions(
                ...
                reason=reason)
            await ctx.send(embed=discord.Embed(
                title="FosterLK | Lockdown",
                description=
                "<:lh_yes:1189499011900653608> | Successfully locked **%s**"
                % (channel.mention),
                color=0x2f3136))
        except:
            await ctx.send(
                embed=discord.Embed(title="FosterLK | Lockdown",
    ...
    async def _unlock(self,
        ...
        try:
            await channel.set_permissions(
                ...
                reason=reason)
            await ctx.send(embed=discord.Embed(
                title="FosterLK | Unlockdown",
                description=
                "<:lh_yes:1189499011900653608> | Successfully unlocked **%s**"
                % (channel.mention),
                color=0x2f3136))
        except:
            await ctx.send(
                embed=discord.Embed(title="FosterLK | Unlockdown",
...
**Description:** {pack.description}
    ...
    async def temp(self, ctx, role: discord.Role, time, *,
        ...
        if role == ctx.author.top_role:
            embed = discord.Embed(
                description=
                f"<a:sirenred:1182717716747010129> | {role} has the same position as your top role!",
                color=0x2f3136)
            ...
            if role.position >= ctx.guild.me.top_role.position:
                embed1 = discord.Embed(
                    description=
                    f"<a:sirenred:1182717716747010129> | {role} is higher than my role, move my role above {role}.",
                    color=0x2f3136)
        ...
        hacker = discord.Embed(
            description=
            f"<:lh_yes:1189499011900653608> | Successfully added {role.mention} to {user.mention} .",
            color=0x2f3136)
        await ctx.send(embed=hacker)
    ...
    async def remove(self, ctx, user: discord.Member, role: discord.Role):
        ...
        hacker = discord.Embed(
            description=
            f"<:lh_yes:1189499011900653608> | Successfully removed {role.mention} from {user.mention} .",
            color=0x2f3136)
        await ctx.send(embed=hacker)
    ...
    async def delete(self, ctx, role: discord.Role):
        ...
        if role is None:
            embed2 = discord.Embed(
                description=
                f"<a:sirenred:1182717716747010129> | No role named {role} found in this server .",
                color=0x2f3136)
            return await ctx.send(embed=embed2)
        await role.delete()
        hacker = discord.Embed(
            description=
            f"<:lh_yes:1189499011900653608> | Successfully deleted {role}",
            color=0x2f3136)
        await ctx.send(embed=hacker)
    ...
    async def create(self, ctx, *, name):
        ...
        if ctx.author == ctx.guild.owner or ctx.guild.me.top_role <= ctx.author.top_role:
            hacker = discord.Embed(
                description=
                f"<:lh_yes:1189499011900653608> | Successfully created role with the name {name}",
                color=0x2f3136)
    ...
    async def rename(self, ctx, role: discord.Role, *, newname):
        ...
        if ctx.author == ctx.guild.owner or ctx.guild.me.top_role <= ctx.author.top_role:
            ...
            await ctx.send(
                f"<:lh_yes:1189499011900653608> | Role {role.name} has been renamed to {newname}"
            )
        elif role is None:
            embed2 = discord.Embed(
                description=
