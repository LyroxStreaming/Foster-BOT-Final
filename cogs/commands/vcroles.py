...
class Voice(commands.Cog):
    ...
    @vc.command(name="kick",
                help="Disconnect a member from a voice channel .",
    ...
    async def _muteall(self, ctx):
        ...
        for member in ctx.author.voice.channel.members:
            if member.voice.mute == False:
                ...
                count += 1
        hacker = discord.Embed(title="FosterLK",
    ...
    async def _addhumans(self, ctx, role: discord.Role):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if role.position >= ctx.guild.me.top_role.position:
                ...
                embed = discord.Embed(
                    description=
                    "<a:sirenred:1182717716747010129> | {} is already in human vcroles ."
                    .format(role.mention),
                    color=0x2f3136)
                ...
                hacker = discord.Embed(
                    description=
                    "<:lh_yes:1189499011900653608> | {} has been added to human vcroles ."
                    .format(role.mention),
                    color=0x2f3136)
    ...
    async def _addbots(self, ctx, role: discord.Role):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if role.position >= ctx.guild.me.top_role.position:
                ...
                embed = discord.Embed(
                    description=
                    "<a:sirenred:1182717716747010129> | {} is already in bot vcroles ."
                    .format(role.mention),
                    color=0x2f3136)
                await ctx.reply(embed=embed, mention_author=False)
            else:
                ...
                hacker = discord.Embed(
                    description=
                    "<:lh_yes:1189499011900653608> | {} has been added to bot vcroles ."
                    .format(role.mention),
                    color=0x2f3136)
                await ctx.send(embed=hacker, mention_author=False)
        else:
    ...
    async def _removehumans(self, ctx, role: discord.Role):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if role.position >= ctx.guild.me.top_role.position:
                ...
                embed = discord.Embed(
                    description=
                    "<a:sirenred:1182717716747010129> | {} is not in human vcroles ."
                    .format(role.mention),
                    color=0x2f3136)
                ...
                hacker = discord.Embed(
                    description=
                    "<:lh_yes:1189499011900653608> | {} has been removed from human vcroles."
                    .format(role.mention),
                    color=0x2f3136)
    ...
    async def _removebots(self, ctx, role: discord.Role):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if role.position >= ctx.guild.me.top_role.position:
                ...
                embed = discord.Embed(
                    description=
                    "<a:sirenred:1182717716747010129> | {} is not in bot vcroles.".
                    format(role.mention),
                    color=0x2f3136)
                await ctx.reply(embed=embed)
            elif role.id == data["vcrole"]["bots"]:
                ...
                hacker = discord.Embed(
                    description=
                    "<:lh_yes:1189499011900653608> | {} has been removed from bot vcroles."
                    .format(role.mention),
                    color=0x2f3136)
                await ctx.send(embed=hacker)
        else:
    ...
    async def _reset(self, ctx):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if data["vcrole"]["humans"] == "" and data["vcrole"]["bots"] == "":
                embed = discord.Embed(
                    description=
                    "<a:sirenred:1182717716747010129> | This server don't have any vcroles setupped .",
                    color=0x2f3136)
                await ctx.send(embed=embed)
            else:
                data["vcrole"]["bots"] = ""
                ...
                hacker = discord.Embed(
                    description=
                    "<:lh_yes:1189499011900653608> | Succesfully cleared all vcroles for this server .",
                    color=0x2f3136)
                await ctx.send(embed=hacker)
        else:
            hacker5 = discord.Embed(
