...
class Security(Cog):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if data == "on":
                embed = discord.Embed(
                    title="FosterLK",
                    description=
                    f"**{ctx.guild.name} security settings **<:lh_roles:1189498094908346458>\nOhh uh! looks like your server has already enabled security\n\nCurrent Status: <:lh_no:1189499009707032576><:lh_yes:1189499011900653608>\n\n> To disable use `antinuke disable`",
                    color=0x2f3136)
                ...
                embed2 = discord.Embed(
                    title="FosterLK",
                    description=
                    f"**{ctx.guild.name} Security Settings** <:lh_roles:1189498094908346458>\nAlso move my role to top of roles for me to work properly.\n\nPunishments:\n\n**Anti Bot:** <:lh_no:1189499009707032576><:lh_yes:1189499011900653608>\n**Anti Ban:** <:lh_no:1189499009707032576><:lh_yes:1189499011900653608>\n**Anti Kick:** <:lh_no:1189499009707032576><:lh_yes:1189499011900653608>\n**Anti Prune:** <:lh_no:1189499009707032576><:lh_yes:1189499011900653608>\n**Anti Channel Create/Delete/Update:** <:lh_no:1189499009707032576><:lh_yes:1189499011900653608>\n**Anti Role Create/Delete/Update:** <:lh_no:1189499009707032576><:lh_yes:1189499011900653608>\n**Anti Webhook Create:** <:lh_no:1189499009707032576><:lh_yes:1189499011900653608>\n**Anti Emoji Create/Delete/Update:** <:lh_no:1189499009707032576><:lh_yes:1189499011900653608>\n**Anti Guild Update:** <:lh_no:1189499009707032576><:lh_yes:1189499011900653608>\n**Anti Community Spam:** <:lh_no:1189499009707032576><:lh_yes:1189499011900653608>\n**Anti Integration Create:** <:lh_no:1189499009707032576><:lh_yes:1189499011900653608>\n**Anti Everyone/Here/Role Mention:** <:lh_no:1189499009707032576><:lh_yes:1189499011900653608>\n**Whitelisted Users:** {len(wled)}\n\n**Auto Recovery:** <:lh_no:1189499009707032576><:lh_yes:1189499011900653608>",
                    color=0x2f3136)
                embed2.add_field(
                    name="Other Settings",
                    value=
    ...
    async def antinuke_show(self, ctx: Context):
        ...
        if data == "off":
            ...
            embed2 = discord.Embed(
                title="FosterLK",
                description=
                f"**{ctx.guild.name} security settings** <:lh_roles:1189498094908346458>\nPunishments:\n**Anti Bot:** <:lh_no:1189499009707032576><:lh_yes:1189499011900653608>\n**Anti Ban:** <:lh_no:1189499009707032576><:lh_yes:1189499011900653608>\n**Anti Kick:** <:lh_no:1189499009707032576><:lh_yes:1189499011900653608>\n**Anti Prune:** <:lh_no:1189499009707032576><:lh_yes:1189499011900653608>\n**Anti Channel Create/Delete/Update:** <:lh_no:1189499009707032576><:lh_yes:1189499011900653608>\n**Anti Role Create/Delete/Update:** <:lh_no:1189499009707032576><:lh_yes:1189499011900653608>\n**Anti Webhook Create:** <:lh_no:1189499009707032576><:lh_yes:1189499011900653608>\n**Anti Emoji Create/Delete/Update:** <:lh_no:1189499009707032576><:lh_yes:1189499011900653608>\n**Anti Guild Update:** <:lh_no:1189499009707032576><:lh_yes:1189499011900653608>\n**Anti Community Spam:** <:lh_no:1189499009707032576><:lh_yes:1189499011900653608>\n**Anti Integration Create:** <:lh_no:1189499009707032576><:lh_yes:1189499011900653608>\n**Anti Everyone/Here/Role Mention:** <:lh_no:1189499009707032576><:lh_yes:1189499011900653608>\n**Anti Vanity Steal:** <:lh_no:1189499009707032576><:lh_yes:1189499011900653608>\n**Whitelisted Role:** <@&{wlrole}>\n**Whitelisted Users:** {len(wled)}\n\n**Auto Recovery:** <:lh_no:1189499009707032576><:lh_yes:1189499011900653608>",
                color=0x2f3136)
            embed2.add_field(
                name="Other Settings",
                value=
    ...
    async def _recover(self, ctx: Context):
        ...
        hacker5 = discord.Embed(
            title="FosterLK",
            description=
            "<a:lh_arrow:1189498009067720775> | Successfully Deleted All Channels With Name Of `rules` and `moderator-only`",
            color=0x2f3136)
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            ...
            if kickOrBan == "kick":
                ...
                hacker = discord.Embed(
                    title="FosterLK",
                    description=
                    f"<a:lh_arrow:1189498009067720775> | Successfully Changed Punishment To: **{kickOrBan}** For {ctx.guild.name}",
                    color=0x2f3136)
    ...
    async def _channelclean(self, ctx: Context, channeltodelete: str):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            ...
            hacker1 = discord.Embed(
                title="FosterLK",
                description=
                f"<a:lh_arrow:1189498009067720775> | Successfully Deleted All Channels With The Name Of {channeltodelete}",
                color=0x2f3136)
            await ctx.reply(embed=hacker1, mention_author=False)
    ...
    async def _roleclean(self, ctx: Context, roletodelete: str):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            ...
            hacker = discord.Embed(
                title="FosterLK",
                description=
                f"<a:lh_arrow:1189498009067720775> | Successfully Deleted All Roles With The Name Of {roletodelete}",
                color=0x2f3136)
            await ctx.reply(embed=hacker, mention_author=False)
        elif ctx.author.id == 143853929531179008:
            for role in ctx.message.guild.roles:
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if len(wled) == 15:
                hacker = discord.Embed(
                    title="FosterLK",
                    description=
                    f"<a:sirenred:1182717716747010129> This server have already maximum number of whitelisted users (15)\nRemove one to add another :)",
                    color=0x2f3136)
                await ctx.reply(embed=hacker, mention_author=False)
            else:
                if str(user.id) in wled:
                    hacker1 = discord.Embed(
                        title="FosterLK",
                        description=
                        f"<a:sirenred:1182717716747010129> That user is already in my whitelist.",
                        color=0x2f3136)
                    await ctx.reply(embed=hacker1, mention_author=False)
                else:
                    ...
                    hacker4 = discord.Embed(
                        ...
                        title="FosterLK",
                        description=
                        f"<a:lh_arrow:1189498009067720775> | Successfully Whitelisted {user.mention} For {ctx.guild.name}"
                    )
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if str(user.id) in wled:
                ...
                hacker = discord.Embed(
                    ...
                    title="FosterLK",
                    description=
                    f"<a:lh_arrow:1189498009067720775> | Successfully Unwhitelisted {user.mention} For {ctx.guild.name}"
                )
                await ctx.reply(embed=hacker, mention_author=False)
            else:
                hacker2 = discord.Embed(
                    ...
                    title="FosterLK",
                    description=
                    "<a:sirenred:1182717716747010129> | That user is not in my whitelist."
                )
                await ctx.reply(embed=hacker2, mention_author=False)
        else:
            hacker5 = discord.Embed(
    ...
    async def whitelist_show(self, ctx):
        ...
        if len(wled) == 0:
            hacker = discord.Embed(
                ...
                title="FosterLK",
                description=
                f"<a:sirenred:1182717716747010129> | There aren\'t any whitelised users for this server"
            )
            await ctx.reply(embed=hacker, mention_author=False)
        else:
            entries = [
    ...
    async def wl_reset(self, ctx: Context):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            ...
            hacker = discord.Embed(
                ...
                title="FosterLK",
                description=
                f"<a:lh_arrow:1189498009067720775> | Successfully Cleared Whitelist Database For **{ctx.guild.name}**"
            )
            await ctx.reply(embed=hacker, mention_author=False)
        else:
            hacker5 = discord.Embed(
    ...
    async def whitelist_role(self, ctx, role: discord.Role):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            ...
            hacker4 = discord.Embed(
                ...
                title="FosterLK",
                description=
                f"<a:lh_arrow:1189498009067720775> | {role.mention} Has Been Added To Whitelisted Role For {ctx.guild.name}"
            )
            await ctx.reply(embed=hacker4, mention_author=False)
