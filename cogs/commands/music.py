...
class DisPlayer(Player):
    ...
    async def invoke_player(self, ctx: commands.Context = None) -> None:
        ...
        try:
            ...
            embed.set_thumbnail(
                url=
                "https://cdn.discordapp.com/attachments/1188335201500278784/1189594290716938260/Foster_Bot.png"
            )
...
class Check:
    ...
    async def userInVoiceChannel(self, ctx, bot):
        ...
        hacker5 = discord.Embed(
            FosterLK,
            description=
            f"<a:sirenred:1182717716747010129> {ctx.author.mention} You are not connected in a voice channel",
            color=0x2f3136)
    ...
    async def botInVoiceChannel(self, ctx, bot):
        ...
        hacker5 = discord.Embed(
            FosterLK,
            description=
            f"<a:sirenred:1182717716747010129> {ctx.author.mention} I'm not connected in a voice channel",
            color=0x2f3136)
        hacker5.set_footer(text=f"Requested By {ctx.author}",
                           icon_url=f"{ctx.author.avatar}")
        hacker5.set_thumbnail(url=f"{ctx.author.avatar}")
    ...
    async def botNotInVoiceChannel(self, ctx, bot):
        ...
        hacker5 = discord.Embed(
            FosterLK,
            description=
            f"<a:sirenred:1182717716747010129> I'm already connected in a voice channel",
            color=0x2f3136)
        hacker5.set_footer(text=f"Requested By {ctx.author}",
                           icon_url=f"{ctx.author.avatar}")
        hacker5.set_thumbnail(url=f"{ctx.author.avatar}")
    ...
    async def userAndBotInSameVoiceChannel(self, ctx, bot):
        ...
        hacker5 = discord.Embed(
            FosterLK,
            description=
            f"<a:sirenred:1182717716747010129> You are not connected in the same voice channel that the bot",
            color=0x2f3136)
        hacker5.set_footer(text=f"Requested By {ctx.author}",
                           icon_url=f"{ctx.author.avatar}")
        hacker5.set_thumbnail(url=f"{ctx.author.avatar}")
    ...
    async def botIsPlaying(self, ctx, bot):
        ...
        hacker5 = discord.Embed(
            FosterLK,
            description=
            f"<a:sirenred:1182717716747010129> There is currently no song to replay",
            color=0x2f3136)
        hacker5.set_footer(text=f"Requested By {ctx.author}",
                           icon_url=f"{ctx.author.avatar}")
        hacker5.set_thumbnail(url=f"{ctx.author.avatar}")
...
#<:volume_down:1056039813712707654>
    ...
    @discord.ui.button(emoji="<:lh_volume_down:1189602315380981952>",
    ...
    async def volume_button(self, interaction: discord.Interaction,
        ...
        if player is None:
            hacker = discord.Embed(
                description=
                "<a:sirenred:1182717716747010129> | I am not connected to a voice channel.",
                color=0x2f3136)
        ...
        if player.is_playing:
            ...
            hacker1 = discord.Embed(
                description=
                "<:lh_yes:1189499011900653608> | Successfully changed player volume to : `50`",
                color=0x2f3136)
            ...
            hacker2 = discord.Embed(
                description=
                f"<a:sirenred:1182717716747010129> | I am not playing anything.",
                color=0x2f3136)
            return await interaction.response.send_message(embed=hacker2,
                                                           ephemeral=True)

    @discord.ui.button(emoji="<:lh_rewind:1189602699184984147>",
                       style=discord.ButtonStyle.grey,
                       row=0)
    async def seek_button(self, interaction: discord.Interaction,
        ...
        if player.is_playing:
            ...
            hacker1 = discord.Embed(
                description=
                "<:lh_yes:1189499011900653608> | Seeked the current player to `10 seconds` .",
                color=0x2f3136)
            return await interaction.response.send_message(embed=hacker1,
                                                           ephemeral=True)
        else:
            hacker2 = discord.Embed(
                description=
                "<a:sirenred:1182717716747010129> | I am not playing anything.",
                color=0x2f3136)
            return await interaction.response.send_message(embed=hacker2,
                                                           ephemeral=True)
    ...
    async def stop_button(self, interaction: discord.Interaction,
        ...
        if player.is_playing:
            ...
            hacker1 = discord.Embed(
                description=
                f"<:lh_yes:1189499011900653608> | Destroyed the player.",
                color=0x2f3136)
            return await interaction.response.send_message(embed=hacker1,
                                                           ephemeral=True)
        else:
    ...
    async def skip_button(self, interaction: discord.Interaction,
        ...
        if player.is_playing:
            ...
            hacker1 = discord.Embed(
                description=
                "<:lh_yes:1189499011900653608> | Successfully Skipped the track .",
                color=0x2f3136)
            return await interaction.response.send_message(embed=hacker1,
                                                           ephemeral=True)
        else:
    ...
    @discord.ui.button(emoji="<:lh_volume_up:1189602313233518692>",
                       style=discord.ButtonStyle.grey,
                       row=0)
    async def vol_button(self, interaction: discord.Interaction,
        ...
        if player.is_playing:
            ...
            hacker1 = discord.Embed(
                description=
                "<:lh_yes:1189499011900653608> | Successfully changed player volume to : `100`",
                color=0x2f3136)
            return await interaction.response.send_message(embed=hacker1,
                                                           ephemeral=True)
        else:
...
class Music(commands.Cog):
    ...
    async def create_nodes(self):
        ...
        await wavelink.NodePool.create_node(
            ...
            host="46.250.229.195",
            port="25578",
            password="Prasad#20080309",
            https=True,
            spotify_client=spotify.SpotifyClient(
                client_id="e6f7da8470aa443c9a315ea170337d02",
                client_secret="d84bd9289ec047c3a8d2d4fc326fb6bf"))
    ...
    async def play(self, ctx: commands.Context, *, search: str):
        ...
        if not getattr(ctx.author, "voice", None):
            nv = discord.Embed(
                description=
                f'<a:sirenred:1182717716747010129> | You are not connected to a voice channel.',
                color=0x2f3136)
        ...
        if not ctx.voice_client:
            ...
            await ctx.send(
                f"<:lh_yes:1189499011900653608> | Successfully Connected To {ctx.author.voice.channel.mention}"
            )
        else:
        ...
        if 'https://open.spotify.com' in str(search):
            ...
            if vc.queue.is_empty and not vc.is_playing():
                ...
                mbed = discord.Embed(
                    color=0x2f3136,
                    description=
                    f"<a:lh_playing:1189604901366530058> [{track.title}](https://discord.gg/dFuTX7cGtk)"
                )
                mbed.add_field(name="<a:lh_playing:1189604901366530058> ", value=f"[{track.title}](https://discord.gg/dFuTX7cGtk)")
                mbed.add_field(name="<:lh_user:1189606602379108545> Requested By", value=f"{ctx.author.mention}")
                mbed.add_field(name="<:lh_studio:1189604903665029242> Song By",
                               value=f"`{track.author}`")
                mbed.add_field(name="<:lh_time:1189604908194869248> Duration",
                ...
                embed = discord.Embed(
                    description=
                    f'[{track}](https://discord.gg/dFuTX7cGtk) Added To The Queue',
                    color=0x2f3136)
            ...
            if vc.queue.is_empty and not vc.is_playing():
                ...
                mbed = discord.Embed(
                    color=0x2f3136,
                    description=
                    f"<a:lh_playing:1189604901366530058> [{track1}](https://discord.gg/dFuTX7cGtk)"
                )
                mbed.add_field(name="Song Url", value=search)
                mbed.add_field(name="<a:lh_playing:1189604901366530058> ", value=f"[{track1}](https://discord.gg/dFuTX7cGtk)")
                mbed.set_author(name="NOW PLAYING",
                                icon_url=f"{ctx.author.avatar}")
                mbed.set_thumbnail(url=self.bot.user.display_avatar.url)
                mbed.set_footer(text=f"Requested By {ctx.author}",
                ...
                embed = discord.Embed(
                    description=
                    f'[{track1}](https://discord.gg/dFuTX7cGtk) Added To The Queue',
                    color=0x2f3136)
            ...
            if vc.queue.is_empty and not vc.is_playing():
                ...
                mbed = discord.Embed(
                    color=0x2f3136,
                    description=
                    f"<a:lh_playing:1189604901366530058> [{track2.title}](https://discord.gg/dFuTX7cGtk)"
                )
                mbed.add_field(name="<a:lh_playing:1189604901366530058> ", value=f"[{track2.title}](https://discord.gg/dFuTX7cGtk)")
                mbed.add_field(name="<:lh_user:1189606602379108545> Requested By", value=f"{ctx.author.mention}")
                mbed.add_field(name="<:lh_studio:1189604903665029242> Song By",
                ...
                embed = discord.Embed(
                    description=
                    f'[{track2}](https://discord.gg/dFuTX7cGtk) Added To The Queue',
                    color=0x2f3136)
        ...
        if not player.queue.is_empty:
            ...
            if hasattr(new_song, 'thumb'):
                mbed = discord.Embed(
                    color=0x2f3136,
                    description=
                    f"<a:lh_playing:1189604901366530058> [{new_song.title}](https://discord.gg/dFuTX7cGtk)"
                )
                mbed.add_field(name="<a:lh_playing:1189604901366530058> ", value=f"[{new_song.title}](https://discord.gg/dFuTX7cGtk)")
                mbed.add_field(name="<:lh_user:1189606602379108545> Requested By", value=f"{ctx.author.mention}")
                mbed.add_field(name="<:lh_studio:1189604903665029242> Song By",
                ...
                mbed.add_field(name="<a:lh_playing:1189604901366530058> ", value=f"[{new_song.title}](https://discord.gg/dFuTX7cGtk)")
                mbed.add_field(
                    name="<:lh_user:1189606602379108545> Requested By",
    ...
    async def connect(self,
        ...
        if channel is None:
            ...
            av = discord.Embed(
                description=
                f"<a:sirenred:1182717716747010129> | I am already connected to a voice channel.",
                color=0x2f3136)
        ...
        sc = discord.Embed(
            description=
            f"<:lh_yes:1189499011900653608> | Successfully connected to {channel.mention}.",
            color=0x2f3136)
    ...
    async def leave_command(self, ctx: commands.Context):
        ...
        if ctx.author.voice is None:
            hacker = discord.Embed(
                description=
                "<a:sirenred:1182717716747010129> | You are not connected to a voice channel.",
                color=0x2f3136)
        ...
        hacker1 = discord.Embed(
            description=
            f"<:lh_yes:1189499011900653608> | Successfully disconnected from {ctx.author.voice.channel.mention}",
            color=0x2f3136)
    ...
    async def skip_command(self, ctx: commands.Context):
        ...
        if player.is_playing:
            ...
            hacker1 = discord.Embed(
                description=
                f"<:lh_yes:1189499011900653608> | Successfully Skipped the track .",
                color=0x2f3136)
    ...
    async def pause_command(self, ctx: commands.Context):
        ...
        if not player.is_paused():
            if player.is_playing():
                ...
                hacker1 = discord.Embed(
                    description=
                    f"<:lh_yes:1189499011900653608> | Successfully paused the player .",
                    color=0x2f3136)
                view = Buttons()
                await ctx.send(embed=hacker1)
            else:
            ...
            hacker3 = discord.Embed(
                description=
                f"<a:sirenred:1182717716747010129> | Player is already paused .",
                color=0x2f3136)
    ...
    async def resume_command(self, ctx: commands.Context):
        ...
        if player.is_paused():
            ...
            hacker1 = discord.Embed(
                description=
                f"<:lh_yes:1189499011900653608> | Successfully resumed the player .",
                color=0x2f3136)
            ...
            hacker3 = discord.Embed(
                description=
                f"<a:sirenred:1182717716747010129> | Player is already resumed .",
                color=0x2f3136)
    ...
    async def boost_command(self, ctx: commands.Context):
        ...
        hacker4 = discord.Embed(
            description=
            "<:lh_yes:1189499011900653608> | Successfully enabled `bass boost` .",
            color=0x2f3136)
    ...
    async def rmvboost_command(self, ctx: commands.Context):
        ...
        hacker4 = discord.Embed(
            description=
            "<:lh_yes:1189499011900653608> | Successfully disabled `bass boost` .",
            color=0x2f3136)
        await ctx.reply(embed=hacker4)
    ...
    async def volume(self, ctx, volume):
        ...
        if ((not volume.isdigit()) or (int(volume)) < 0
            ...
            hacker = discord.Embed(
                description=
                "<a:sirenred:1182717716747010129> | Volume Must Be 0 To 500 .",
                color=0x2f3136)
            hacker.set_footer(text=f"Requested By {ctx.author}",
                              icon_url=f"{ctx.author.avatar}")
            hacker.set_thumbnail(url = f"{ctx.author.avatar}")
        ...
        hacker4 = discord.Embed(
            description=
            f"<:lh_yes:1189499011900653608> | Successfully changed player volume to : `{volume}%`",
            color=0x2f3136)
    ...
    async def playing(self, ctx):
        if not ctx.voice_client:
            hacker = discord.Embed(
                description=
                "<a:sirenred:1182717716747010129> | Not connected to a voice channel.",
                color=0x2f3136)
            hacker.set_footer(text=f"Requested By {ctx.author}",
                              icon_url=f"{ctx.author.avatar}")
            hacker.set_thumbnail(url=f"{ctx.author.avatar}")
        ...
        em = discord.Embed(
            description=f"[{vc.track}](https://discord.gg/dFuTX7cGtk)",
            color=0x2f3136)

        em.add_field(name="<:lh_studio:1189604903665029242> Song By",
                     value=f"`{vc.track.author}`")
        em.add_field(
            name="<:lh_time:1189604908194869248> Duration",
    ...
    async def shuffle(self, ctx):
        ...
        hacker2 = discord.Embed(
            description=
            "<:lh_yes:1189499011900653608> | Successfully shuffled the current queue .",
            color=0x2f3136)
    ...
    async def pull(self, ctx, index: int):
        ...
        if index > len(vc.queue) or index < 1:
            hacker2 = discord.Embed(
                description=
                f"<a:sirenred:1182717716747010129> | Must Be Between 1 And {len(vc.queue)} .",
                color=0x2f3136)
            return await ctx.reply(embed=hacker2)
        ...
        hacker3 = discord.Embed(
            description=
            f"<:lh_yes:1189499011900653608> | Successfully pulled out `{removed.title}` From Queue .",
            color=0x2f3136)
    ...
    async def _queue(self, ctx):
        if not ctx.voice_client:
            ...
            hacker1 = discord.Embed(
                description=
                "<a:sirenred:1182717716747010129> | You need to join a voice channel to play something .",
                color=0x2f3136)
            return await ctx.send(embed=hacker1)
        else:
            vc: wavelink.Player = ctx.voice_client
        ...
        if vc.queue.is_empty:
            hacker3 = discord.Embed(
                description=
                f"<a:sirenred:1182717716747010129> | No songs in queue .",
                color=0x2f3136)
        ...
        for song in copy:
            ...
            hacker4.add_field(name=f"Position : {count}",
                              value=f"[{song.title}](https://discord.gg/dFuTX7cGtk)")
    ...
    async def _clear(self, ctx):
        ...
        hacker3 = discord.Embed(
            description=
            f"<:lh_yes:1189499011900653608> | Successfully Clears The current Queue .",
            color=0x2f3136)
        hacker3.set_footer(text=f"Requested By {ctx.author}",
                           icon_url=f"{ctx.author.avatar}")
        return await ctx.send(embed=hacker3)
    ...
    async def seek_command(self, ctx, position: str):
        ...
        hacker3 = discord.Embed(
            description=
            f"<:lh_yes:1189499011900653608> | Successfully Seeked the current player to {secs} .",
            color=0x2f3136)
