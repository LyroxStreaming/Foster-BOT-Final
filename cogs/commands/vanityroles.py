...
class Vanityroles(commands.Cog):
            ...
            if ctx.author == ctx.guild.owner or ctx.guild.me.top_role <= ctx.author.top_role:
                if role.permissions.administrator or role.permissions.ban_members or role.permissions.kick_members:
                    embed1 = discord.Embed(
                        description=
                        "<a:sirenred:1182717716747010129> | Please Select Role That Dont Have Any Type Of Dangerous Permissions.",
                        color=0x2f3136)
                    ...
                    embed.add_field(
                        name="<a:lh_arrow:1189498009067720775> Vanity",
                        value=f"{vanity}",
                        inline=False)
                    embed.add_field(
                        name="<a:lh_arrow:1189498009067720775> Role",
                        value=f"{role.mention}",
                        inline=False)
                    embed.add_field(
                        name="<a:lh_arrow:1189498009067720775> Channel",
        ...
        with open("vanityroles.json", "r") as f:
            ...
            if ctx.author == ctx.guild.owner or ctx.guild.me.top_role <= ctx.author.top_role:
                if str(ctx.guild.id) not in jnl:
                    embed1 = discord.Embed(
                        description=
                        "<a:sirenred:1182717716747010129> | This server don't have any vanity roles setupped yet .",
                        color=0x2f3136)
    ...
    async def config(self, ctx):
        ...
        if str(ctx.guild.id) not in jnl:
            ...
            embed.add_field(name="<a:lh_arrow:1189498009067720775> Vanity",
                            value=f"{vanity}",
                            inline=False)
            embed.add_field(name="<a:lh_arrow:1189498009067720775> Role",
                            value=f"{randirole.mention}",
                            inline=False)
            embed.add_field(name="<a:lh_arrow:1189498009067720775> Channel",
