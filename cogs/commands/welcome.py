    ...
    async def _autorole_humans_reset(self, ctx):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if rl == []:
                embed = discord.Embed(
                    description=
                    "<a:sirenred:1182717716747010129> | This server don't have any autoroles setupped .",
                    color=0x2f3136)
                ...
                if rl != []:
                    ...
                    hacker = discord.Embed(
                        description=
                        f"<:lh_yes:1189499011900653608> | Succesfully cleared all human autoroles for {ctx.guild.name} .",
                        color=0x2f3136)
    ...
    async def _autorole_bots_reset(self, ctx):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if rl == []:
                embed = discord.Embed(
                    description=
                    f"<a:sirenred:1182717716747010129> | This server don't have any autoroles setupped .",
                    color=0x2f3136)
                await ctx.send(embed=embed)
            else:
                if rl != []:
                    ...
                    hacker = discord.Embed(
                        description=
                        f"<:lh_yes:1189499011900653608> | Succesfully cleared all bot autoroles for this server .",
                        color=0x2f3136)
                    await ctx.send(embed=hacker)
        else:
            hacker5 = discord.Embed(
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if len(brl) == 0 and len(hrl) == 0:
                ...
                if hrl != []:
                    ...
                    hacker = discord.Embed(
                        description=
                        f"<:lh_yes:1189499011900653608> | Succesfully cleared all autoroles for this server .",
                        color=0x2f3136)
                    await ctx.send(embed=hacker)
        else:
            hacker5 = discord.Embed(
    ...
    async def _autorole_humans_add(self, ctx, role: discord.Role):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if len(rl) == 5:
                embed = discord.Embed(
                    description=
                    f"<a:sirenred:1182717716747010129> | You have reached maximum channel limit for autorole humans which is five .",
                    color=0x2f3136)
                await ctx.send(embed=embed)
            else:
                if str(role.id) in rl:
                    embed1 = discord.Embed(
                        description=
                        "<a:sirenred:1182717716747010129> | {} is already in human autoroles ."
                        .format(role.mention),
                        color=0x2f3136)
                    ...
                    hacker = discord.Embed(
                        description=
                        f"<:lh_yes:1189499011900653608> | {role.mention} has been added to human autoroles .",
                        color=0x2f3136)
                    await ctx.send(embed=hacker)
        else:
            hacker5 = discord.Embed(
    ...
    async def _autorole_humans_remove(self, ctx, role: discord.Role):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if len(rl) == 0:
                embed = discord.Embed(
                    description=
                    f"<a:sirenred:1182717716747010129> | This server dont have any autrole humans setupped yet .",
                    color=0x2f3136)
                await ctx.send(embed=embed)
            else:
                if str(role.id) not in rl:
                    ...
                    hacker = discord.Embed(
                        description=
                        f"<:lh_yes:1189499011900653608> | {role.mention} has been removed from human autoroles .",
                        color=0x2f3136)
                    await ctx.send(embed=hacker)
        else:
            hacker5 = discord.Embed(
    ...
    async def _autorole_bots_add(self, ctx, role: discord.Role):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if len(rl) == 5:
                embed = discord.Embed(
                    description=
                    f"<a:sirenred:1182717716747010129> | You have reached maximum role limit for autorole bots which is five.",
                    color=0x2f3136)
                await ctx.send(embed=embed)
            else:
                if str(role.id) in rl:
                    embed1 = discord.Embed(
                        description=
                        "<a:sirenred:1182717716747010129> | {} is already in bot autoroles."
                        .format(role.mention),
                        color=0x2f3136)
                    await ctx.send(embed=embed1)
                else:
                    ...
                    hacker = discord.Embed(
                        description=
                        f"<:lh_yes:1189499011900653608> | {role.mention} has been added to bot autoroles .",
                        color=0x2f3136)
                    await ctx.send(embed=hacker)
        else:
            hacker5 = discord.Embed(
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if len(rl) == 0:
                ...
                if str(role.id) not in rl:
                    embed1 = discord.Embed(
                        description=
                        "<a:sirenred:1182717716747010129> | {} is not in bot autoroles."
                        .format(role.mention),
                        color=0x2f3136)
                    await ctx.send(embed=embed1)
                else:
                    ...
                    hacker = discord.Embed(
                        description=
                        f"<:lh_yes:1189499011900653608> | {role.mention} has been removed from bot autoroles.",
                        color=0x2f3136)
                    await ctx.send(embed=hacker)
        else:
            hacker5 = discord.Embed(
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if streamables.search(thumbnail_link):
                ...
                hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    "<a:lh_arrow:1189498009067720775> | Successfully updated the welcome thumbnail url .",
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if streamables.search(image_link):
                ...
                hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    "<a:lh_arrow:1189498009067720775> | Successfully updated the welcome image url .",
                    timestamp=ctx.message.created_at)
                hacker.set_author(name=f"{ctx.author.name}",
                                  icon_url=f"{ctx.author.avatar}")
                await ctx.send(embed=hacker)
    ...
    async def _greet_autodel(self, ctx, *, autodelete_second):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            ...
            hacker = discord.Embed(
                color=0x2f3136,
                description=
                f"<a:lh_arrow:1189498009067720775> | Successfully updated the welcome autodelete second to {autodelete_second} .\nFrom now welcome message will be deleted after {autodelete_second} .",
                timestamp=ctx.message.created_at)
            hacker.set_author(name=f"{ctx.author.name}",
                              icon_url=f"{ctx.author.avatar}")
            await ctx.send(embed=hacker)
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            ...
            try:
                ...
                hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    f"<a:lh_arrow:1189498009067720775> | Successfully updated the welcome message .",
                    timestamp=ctx.message.created_at)
                hacker.set_author(name=f"{ctx.author.name}",
                                  icon_url=f"{ctx.author.avatar}")
                await ctx.send(embed=hacker)
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if data["welcome"]["embed"] == True:
                ...
                hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    f"<a:lh_arrow:1189498009067720775> | Okay, Now your embed is removed and welcome message will be a plain message .",
                    timestamp=ctx.message.created_at)
                hacker.set_author(name=f"{ctx.author.name}",
                                  icon_url=f"{ctx.author.avatar}")
                await ctx.send(embed=hacker)
                ...
                hacker1 = discord.Embed(
                    color=0x2f3136,
                    description=
                    f"<a:lh_arrow:1189498009067720775> | Okay, Now your embed is enabled and welcome message will be a embed message.",
                    timestamp=ctx.message.created_at)
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if data["welcome"]["ping"] == True:
                ...
                hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    f"<a:lh_arrow:1189498009067720775> | Okay, Now your embed ping is disabled and users won't get pinged upon welcome .",
                    timestamp=ctx.message.created_at)
                hacker.set_author(name=f"{ctx.author.name}",
                                  icon_url=f"{ctx.author.avatar}")
                await ctx.send(embed=hacker)
                ...
                hacker1 = discord.Embed(
                    color=0x2f3136,
                    description=
                    f"<a:lh_arrow:1189498009067720775> | Okay, Now your embed ping is enabled and I will ping new users outside the embed .",
                    timestamp=ctx.message.created_at)
                hacker1.set_author(name=f"{ctx.author.name}",
                                   icon_url=f"{ctx.author.avatar}")
                await ctx.send(embed=hacker1)
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if len(chh) == 1:
                hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    f"<:lh_no:1189499009707032576> | You have reached maximum channel limit for channel which is one .",
                    timestamp=ctx.message.created_at)
                hacker.set_author(name=f"{ctx.author.name}",
                                  icon_url=f"{ctx.author.avatar}")
                await ctx.send(embed=hacker)
                ...
                if str(channel.id) in chh:
                    hacker1 = discord.Embed(
                        color=0x2f3136,
                        description=
                        f"<:lh_no:1189499009707032576> | This channel is already in the welcome channels list .",
                        timestamp=ctx.message.created_at)
                    hacker1.set_author(name=f"{ctx.author.name}",
                                       icon_url=f"{ctx.author.avatar}")
                    await ctx.send(embed=hacker1)
                    ...
                    hacker4 = discord.Embed(
                        color=0x2f3136,
                        description=
                        f"<a:lh_arrow:1189498009067720775> | Successfully added {channel.mention} to welcome channel list .",
                        timestamp=ctx.message.created_at)
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if len(chh) == 0:
                hacker = discord.Embed(
                    color=0x2f3136,
                    description=
                    f"<:lh_no:1189499009707032576> | This server dont have any welcome channel setupped yet .",
                    timestamp=ctx.message.created_at)
                hacker.set_author(name=f"{ctx.author.name}",
                                  icon_url=f"{ctx.author.avatar}")
                await ctx.send(embed=hacker)
                ...
                if str(channel.id) not in chh:
                    hacker1 = discord.Embed(
                        color=0x2f3136,
                        description=
                        f"<:lh_no:1189499009707032576> | This channel is not in the welcome channels list .",
                        timestamp=ctx.message.created_at)
                    hacker1.set_author(name=f"{ctx.author.name}",
                                       icon_url=f"{ctx.author.avatar}")
                    await ctx.send(embed=hacker1)
                    ...
                    hacker3 = discord.Embed(
                        color=0x2f3136,
                        description=
                        f"<a:lh_arrow:1189498009067720775> | Successfully removed {channel.mention} from welcome channel list .",
                        timestamp=ctx.message.created_at)
    ...
    async def welctestt(self, ctx):
        ...
        if chan == []:
            hacker = discord.Embed(
                color=0x2f3136,
                description=
                f"<:lh_no:1189499009707032576> | Oops, Kindly setup your welcome channel first .",
                timestamp=ctx.message.created_at)
            hacker.set_author(name=f"{ctx.author.name}",
                              icon_url=f"{ctx.author.avatar}")
            await ctx.send(embed=hacker)
