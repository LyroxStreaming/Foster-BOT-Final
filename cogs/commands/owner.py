...
class Owner(commands.Cog):
    ...
    async def _slist(self, ctx):
        ...
        paginator = Paginator(source=DescriptionEmbedPaginator(
            entries=entries,
            description="",
            title=f"Server List of FosterLK - {len(self.client.guilds)}",
            color=0x2f3136,
            per_page=10),
                              ctx=ctx)
        ...
        if ctx.invoked_subcommand is None:
            with open("blacklist.json") as file:
                ...
                paginator = Paginator(source=DescriptionEmbedPaginator(
                    entries=entries,
                    title=
                    f"List of Blacklisted users of FosterLK - {len(blacklist['ids'])}",
                    description="",
                    per_page=10,
                    color=0x2f3136),
                                      ctx=ctx)
    ...
    async def blacklist_remove(self, ctx, member: discord.Member = None):
        try:
            ...
            embed = discord.Embed(
                ...
                description=
                f"<a:lh_arrow:1189498009067720775> | **{member.name}** has been successfully removed from the blacklist",
                color=0x2f3136)
            with open("blacklist.json") as file:
                blacklist = json.load(file)
                embed.set_footer(
    ...
    async def np_list(self, ctx):
        with open("info.json") as f:
            ...
            paginator = Paginator(source=DescriptionEmbedPaginator(
                entries=entries,
                title=f"No Prefix of FosterLK - {len(nplist)}",
                description="",
                per_page=10,
                color=0x2f3136),
                                  ctx=ctx)
    ...
    async def np_add(self, ctx, user: discord.User):
        ...
        with open('info.json', 'w') as idk:
            ...
            embed1 = discord.Embed(
                description=
                f"<a:lh_arrow:1189498009067720775> | Added no prefix to {user} for all",
                color=0x2f3136)
    ...
    async def np_remove(self, ctx, user: discord.User):
        ...
        with open('info.json', 'w') as idk:
            ...
            embed2 = discord.Embed(
                description=
                f"<a:lh_arrow:1189498009067720775> | Removed no prefix from {user} for all",
                color=0x2f3136)
    ...
    async def badge_add(self, ctx, member: discord.Member, *, badge: str):
        ...
        if badge.lower() in ["own", "owner", "king"]:
            idk = "*<a:lh_owner:1189498119872839782> Owner*"
            ok.append(idk)
            makebadges(member.id, ok)
            embed2 = discord.Embed(
                
                description=
                f"<a:lh_arrow:1189498009067720775> | **Successfully Added `Owner` Badge To {member}**",
                color=0x2f3136)
            await ctx.reply(embed=embed2)
        elif badge.lower() in ["staff", "support staff"]:
            idk = "*<a:lh_moderator:1189498071546069062> Staff*"
            ok.append(idk)
            makebadges(member.id, ok)
            embed3 = discord.Embed(
                
                description=
                f"<a:lh_arrow:1189498009067720775> | **Successfully Added `Staff` Badge To {member}**",
                color=0x2f3136)
            await ctx.reply(embed=embed3)
        elif badge.lower() in ["partner"]:
            idk = "*<:Partnered_Server_Owner73:1189584071437860966> Partner*"
            ok.append(idk)
            makebadges(member.id, ok)
            embed4 = discord.Embed(
                
                description=
                f"<a:lh_arrow:1189498009067720775> | **Successfully Added `Partner` Badge To {member}**",
                color=0x2f3136)
            
            await ctx.reply(embed=embed4)
        elif badge.lower() in ["sponsor"]:
            idk = "*<:lh_sponser:1189610041645482045> Sponsor*"
            ok.append(idk)
            makebadges(member.id, ok)
            embed5 = discord.Embed(
                
                description=
                f"<a:lh_arrow:1189498009067720775> | **Successfully Added `Sponsor` Badge To {member}**",
                color=0x2f3136)
            ...
            idk = "*<:lh_friends:1189610669495033996> Owner`s Friends*"
            ok.append(idk)
            makebadges(member.id, ok)
            embed1 = discord.Embed(
                
                description=
                f"<a:lh_arrow:1189498009067720775> | **Successfully Added `Owner's Friend` Badge To {member}**",
                color=0x2f3136)
            
            await ctx.reply(embed=embed1)
        elif badge.lower() in ["early", "supporter", "support"]:
            idk = "*<:Discord_Early_Supporter73:1189584035840794635> Early Supporter*"
            ok.append(idk)
            makebadges(member.id, ok)
            embed6 = discord.Embed(
                
                description=
                f"<a:lh_arrow:1189498009067720775> | **Successfully Added `Early Supporter` Badge To {member}**",
                color=0x2f3136)
            
            await ctx.reply(embed=embed6)

        elif badge.lower() in ["vip"]:
            idk = "*<a:lh_vip:1189610671885795428> Vip*"
            ok.append(idk)
            makebadges(member.id, ok)
            embed7 = discord.Embed(
                
                description=
                f"<a:lh_arrow:1189498009067720775> | **Successfully Added `VIP` Badge To {member}**",
                color=0x2f3136)
            
            await ctx.reply(embed=embed7)

        elif badge.lower() in ["bug", "hunter"]:
            idk = "*<a:lh_bughunter:1189610665262989385> Bug Hunter*"
            ok.append(idk)
            makebadges(member.id, ok)
            embed8 = discord.Embed(
                
                description=
                f"<a:lh_arrow:1189498009067720775> | **Successfully Added `Bug Hunter` Badge To {member}**",
                color=0x2f3136)
            
            await ctx.reply(embed=embed8)
        elif badge.lower() in ["all"]:
            idk = "*<a:lh_owner:1189498119872839782> Owner\n<a:lh_moderator:1189498071546069062> Staff\n<:Partnered_Server_Owner73:1189584071437860966> Partner\n<:lh_sponser:1189610041645482045> Sponsor\n<:lh_friends:1189610669495033996> Owner`s Friends\n<:Discord_Early_Supporter73:1189584035840794635> Early Supporter\n<a:lh_vip:1189610671885795428> Vip\n<a:lh_bughunter:1189610665262989385> Bug Hunter*"
            ok.append(idk)
            makebadges(member.id, ok)
            embedall = discord.Embed(
                
                description=
                f"<a:lh_arrow:1189498009067720775> | **Successfully Added `All` Badges To {member}**",
                color=0x2f3136)
    ...
    async def badge_remove(self, ctx, member: discord.Member, *, badge: str):
        ...
        if badge.lower() in ["own", "owner", "king"]:
            ...
            embed2 = discord.Embed(
                ...
                description=
                f"<a:lh_arrow:1189498009067720775> | **Successfully Removed `Owner` Badge To {member}**",
                color=0x2f3136)
            ...
            embed3 = discord.Embed(
                ...
                description=
                f"<a:lh_arrow:1189498009067720775> | **Successfully Removed `Staff` Badge To {member}**",
                color=0x2f3136)
            ...
            embed4 = discord.Embed(
                ...
                description=
                f"<a:lh_arrow:1189498009067720775> | **Successfully Removed `Partner` Badge To {member}**",
                color=0x2f3136)
            ...
            embed5 = discord.Embed(
                ...
                description=
                f"<a:lh_arrow:1189498009067720775> | **Successfully Removed `Sponsor` Badge To {member}**",
                color=0x2f3136)
            ...
            idk = "*<:lh_friends:1189610669495033996> Owner's Friend*"
            ok.remove(idk)
            makebadges(member.id, ok)
            embed1 = discord.Embed(
                
                description=
                f"<a:lh_arrow:1189498009067720775> | **Successfully Removed `Owner's Friend` Badge To {member}**",
                color=0x2f3136)
            ...
            embed6 = discord.Embed(
                ...
                description=
                f"<a:lh_arrow:1189498009067720775> | **Successfully Removed `Early Supporter` Badge To {member}**",
                color=0x2f3136)
            ...
            embed7 = discord.Embed(
                ...
                description=
                f"<a:lh_arrow:1189498009067720775> | **Successfully Removed `VIP` Badge To {member}**",
                color=0x2f3136)
            ...
            embedall = discord.Embed(
                ...
                description=
                f"<a:lh_arrow:1189498009067720775> | **Successfully Removed `All` Badges From {member}**",
                color=0x2f3136)
            await ctx.reply(embed=embedall)
        else:
            hacker = discord.Embed(
    ...
    async def dm(self, ctx, user: discord.User, *, message: str):
        ...
        try:
            ...
            await ctx.send(f"<a:lh_arrow:1189498009067720775> | Successfully Sent a DM to **{user}**")
    ...
    async def change_nickname(self, ctx, *, name: str = None):
        ...
        try:
            ...
            if name:
                await ctx.send(f"<a:lh_arrow:1189498009067720775> | Successfully changed nickname to **{name}**")
            else:
                await ctx.send("<a:lh_arrow:1189498009067720775> | Successfully removed nickname")
